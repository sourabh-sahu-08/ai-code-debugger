...
import { Clock, AlertTriangle, Database, Sparkles, Download, Terminal, Split, LayoutList, ChevronLeft, ShieldCheck, Activity } from "lucide-react";
      ...
      <Layout>
        <div className="max-w-xl mx-auto pt-40 px-6 text-center">
          <div className="card-premium p-12 space-y-6">
            ...
            <Link
              to="/"
              className="inline-flex items-center gap-2 text-blue-400 font-bold hover:text-white transition-colors pt-4"
            >
              <ChevronLeft size={16} />
              Return to Workspace
            </Link>
            ...
            {[
              ...
              <button
                ...
                className={`flex items-center gap-2 px-4 py-2 rounded-lg text-xs font-black uppercase tracking-widest transition-all ${
                  viewMode === mode.id ? "bg-blue-600 text-white" : "text-slate-500 hover:text-white"
                }`}
              >
                <mode.icon size={14} />
                {mode.label}
          ...
          {viewMode === "diff" ? (
            ...
            >
              <div className="card-premium overflow-hidden">
                <div className="px-6 py-4 border-b border-white/5 bg-white/2 text-xs font-black uppercase tracking-widest text-slate-500">
                  Input_Buffer
                </div>
              ...
              <div className="card-premium overflow-hidden border-blue-500/20">
                <div className="px-6 py-4 border-b border-white/5 bg-blue-500/5 text-xs font-black uppercase tracking-widest text-blue-400">
                  Resolution_Output
                </div>
                <div className="h-[400px]">
                  <Editor
        ...
        <div className="mt-20 card-premium p-16 text-center space-y-8 relative overflow-hidden">
          ...
          <div className="relative z-10 space-y-6">
            ...
            <p className="text-slate-500 max-w-xl mx-auto font-medium">
              Join the secure neural auditing workspace today.
            </p>
            <Link
              to="/auth/register"
              className="bg-blue-600 hover:bg-blue-500 text-white px-10 py-4 rounded-2xl font-black text-xs uppercase tracking-[0.2em] transition-all inline-block shadow-2xl shadow-blue-500/20"
            >
