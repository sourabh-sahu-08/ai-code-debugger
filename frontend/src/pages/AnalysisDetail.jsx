...
export default function AnalysisDetail() {
  ...
  const handleTogglePublic = async () => {
    try {
      ...
      setAnalysis(response.data.data);
      toast.success(
        response.data.data.isPublic ? "Global visibility enabled" : "Privacy protocol activated"
      );
    } catch (err) {
      ...
      <Layout>
        <div className="flex flex-col items-center justify-center h-[80vh] space-y-8">
          ...
          <div className="text-center space-y-2">
            <p className="text-white font-black text-xl tracking-[0.2em] uppercase animate-shimmer bg-clip-text text-transparent">
              Decoding Metadata
            </p>
      ...
      <Layout>
        <div className="max-w-6xl mx-auto pt-32 px-6">
          ...
          >
            ...
            <h2 className="text-3xl text-white font-black mb-4 tracking-tight">
              Access Protocol Failure
            </h2>
            <p className="text-slate-400 mb-12 leading-relaxed font-medium text-lg">
              {error || "The requested analysis does not exist in our neural core."}
            </p>
            <Link
              to="/dashboard"
              className="bg-slate-900 hover:bg-slate-800 text-white px-10 py-5 rounded-2xl font-black uppercase tracking-widest text-xs transition-all inline-flex items-center gap-4 border border-white/5 shadow-xl"
            >
              <ArrowLeft size={18} />
              Return to Nexus
            </Link>
  ...
  return (
    <Layout>
      <div className="fixed top-0 left-0 w-full h-1 z-[100] pointer-events-none">
        <motion.div
          className="h-full bg-blue-500 origin-left shadow-[0_0_15px_rgba(59,130,246,0.5)]"
      ...
      <div className="max-w-[1400px] mx-auto pt-24 px-6 pb-24">
        <motion.div initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }}>
          <Link
            to="/dashboard"
            className="text-slate-500 hover:text-white flex items-center gap-2 mb-12 transition-all font-black text-xs tracking-widest group w-fit"
          >
        ...
        <div className="flex flex-col xl:flex-row xl:items-end justify-between mb-16 gap-10">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
            <div className="flex items-center gap-5 mb-4">
              ...
              <div>
                <h1 className="text-5xl font-black text-white tracking-tighter mb-1 font-bold">
                  Analysis Report
                </h1>
          ...
          <motion.div
            ...
            className="glass px-10 py-6 rounded-[2.5rem] border border-white/5 flex flex-wrap items-center gap-8 shadow-2xl"
          >
              ...
              <div className="flex items-center gap-4">
                <div className="h-2 w-40 bg-slate-950 rounded-full overflow-hidden border border-white/5 shadow-inner">
                  <motion.div
                    ...
                    className="h-full bg-gradient-to-r from-blue-600 to-indigo-600 shadow-[0_0_10px_rgba(59,130,246,0.3)]"
                  />
                </div>
            ...
            <div className="flex items-center gap-3">
              <button
                ...
                className={`w-12 h-12 rounded-2xl flex items-center justify-center transition-all active:scale-90 border shadow-lg ${
                  analysis.isPublic
              ...
              <button
                ...
                className="w-12 h-12 rounded-2xl bg-white/5 hover:bg-white/10 flex items-center justify-center text-slate-500 hover:text-white transition-all active:scale-90 border border-white/5 shadow-lg"
              ...
              <button
                ...
                className={`w-12 h-12 rounded-2xl flex items-center justify-center transition-all active:scale-90 border relative shadow-lg ${
                  !analysis.isPublic
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 mb-12">
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
            className="lg:col-span-8 glass p-12 rounded-[3rem] border-l-4 border-l-blue-600 relative overflow-hidden group shadow-2xl"
          >
            ...
            <div className="bg-slate-950/40 p-8 rounded-[2rem] border border-white/5 shadow-inner">
              <pre className="text-slate-300 leading-relaxed font-mono text-base whitespace-pre-wrap">
                {analysis.findings}
              </pre>
            </div>
          </motion.div>
          ...
          <div className="lg:col-span-4 flex flex-col gap-8">
            <motion.div
              ...
              className="glass p-10 rounded-[2.5rem] border border-white/5 shadow-2xl flex items-center gap-6 group hover:border-blue-500/20 transition-all"
            >
              ...
              <div>
                ...
                <p className="text-3xl font-mono text-white font-bold tracking-tighter">
            ...
            <motion.div
              initial={{ opacity: 0, x: 20 }}
              animate={{ opacity: 1, x: 0 }}
              className="glass p-10 rounded-[2.5rem] border border-white/5 shadow-2xl flex items-center gap-6 group hover:border-emerald-500/20 transition-all"
            >
        ...
        <motion.div
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
          className="glass p-12 rounded-[3.5rem] mb-20 border border-white/5 shadow-3xl relative overflow-hidden group"
        >
          ...
          <p className="text-slate-200 leading-relaxed whitespace-pre-wrap text-2xl font-bold tracking-tight relative z-10">
            {analysis.explanation}
          </p>
        </motion.div>
