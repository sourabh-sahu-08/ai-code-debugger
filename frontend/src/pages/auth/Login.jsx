        ...
        <Card className="bg-surface/50 border-border/50 backdrop-blur-xl">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div className="space-y-1">
                <div className="flex items-center justify-between">
                  ...
                  <Link to="/auth/forgot-password" className="text-xs font-medium text-text hover:text-primary-electric transition-colors">
                    Forgot password?
                  </Link>
                </div>
                <Input 
          ...
          <CardFooter className="flex justify-center border-t border-border/50 pt-6">
            <p className="text-sm text-text-muted">
              ...
              <Link to="/auth/register" className="font-medium text-text hover:text-primary-electric transition-colors">
                Sign up now
              </Link>
            </p>
          </CardFooter>
