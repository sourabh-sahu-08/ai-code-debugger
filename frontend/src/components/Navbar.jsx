...
export default function Navbar() {
  ...
  return (
    <motion.nav
      ...
      className="fixed inset-x-0 top-0 z-[100] border-b border-white/10 bg-[#050a15]/75 backdrop-blur-2xl"
    >
            ...
            <form onSubmit={handleSearch} className="hidden lg:block">
              <label className="relative block">
                ...
                <input
                  ...
                  className="w-[26rem] rounded-2xl border border-white/10 bg-white/5 py-3 pl-11 pr-4 text-xs text-white placeholder:text-slate-500 focus:outline-none focus:ring-2 focus:ring-sky-400/20 transition-all"
                />
              </label>
            </form>
          )}
