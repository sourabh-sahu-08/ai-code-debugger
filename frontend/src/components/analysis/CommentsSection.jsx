...
export default function CommentsSection({ analysisId, initialComments = [] }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      toast.error("Failed to add developer note.");
    } finally {
  ...
  return (
    <div className="space-y-8">
          ...
          {comments.length === 0 ? (
            ...
            >
              ...
              <p className="text-slate-500 text-sm font-medium italic">
                Developer logs are isolated and protected. Add one above.
              </p>
            </motion.div>
          ) : (
      ...
      <ConfirmModal
        ...
        message="This action cannot be undone. The note will be permanently purged from database archives."
